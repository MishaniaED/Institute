...
class Graph:
    ...
    def findEdgeByVertexes(self, start: Vertex, end: Vertex):
        for edge in self._edgeList:
    ...
    def reverse(self):
        for edge in self._edgeList:
            tmp = edge._startVertex
            edge._startVertex = edge._endVertex
            edge._endVertex = tmp
    ...
    def setEdgesFromAdjacentMatrix(self, adjMatrix):
        self._edgeList.clear()
