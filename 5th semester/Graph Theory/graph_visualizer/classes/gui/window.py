...
class Window(QtWidgets.QMainWindow):
    ...
    def _createMenuBar(self):
        ...
        algoBestfirst = QtWidgets.QAction('ЛР №3. Поиск по первому наилучшему совпадению', self)
        ...
        algoAstar = QtWidgets.QAction('ЛР №5. Алгоритм A-star', self)
        algoAstar.triggered.connect(self._view.viewAstar)
        tasksMenu.addAction(algoAstar)

        algoParams = QtWidgets.QAction('ЛР №6. Вес, радиус диаметр и степени', self)
        algoParams.triggered.connect(self._view.viewParams)
        tasksMenu.addAction(algoParams)

        algoIsomorphism = QtWidgets.QAction('ЛР №7. Изоморфизм графов', self)
        algoIsomorphism.triggered.connect(self._view.viewIsomorphism)
        tasksMenu.addAction(algoIsomorphism)

        algoConnectivity = QtWidgets.QAction('ЛР №8. Связность графа.', self)
        algoConnectivity.triggered.connect(self._view.viewConnectivity)
        tasksMenu.addAction(algoConnectivity)

        algoComp = QtWidgets.QAction('ЛР №9. Дополнение графа', self)
        algoComp.triggered.connect(self._view.viewComp)
        tasksMenu.addAction(algoComp)

        algoPlanarity = QtWidgets.QAction('ЛР №10. Планарность графа', self)
        algoPlanarity.triggered.connect(self._view.viewPlanarity)
        tasksMenu.addAction(algoPlanarity)

        algoVector = QtWidgets.QAction('ЛР №11. Восстановление графа из вектора', self)
        algoVector.triggered.connect(self._view.viewVector)
        tasksMenu.addAction(algoVector)

        algoExtreme = QtWidgets.QAction('ЛР №12. Экстремальные графы', self)
        algoExtreme.triggered.connect(self._view.viewExtreme)
        tasksMenu.addAction(algoExtreme)
        ...
        algoWedding = QtWidgets.QAction('ЛР №16. Задача о свадьбах', self)
        algoWedding.triggered.connect(self._view.viewWedding)
        tasksMenu.addAction(algoWedding)

        algoTSP = QtWidgets.QAction('ЛР №20. Задача коммивояжёра', self)
        algoTSP.triggered.connect(self._view.view20)
        tasksMenu.addAction(algoTSP)
